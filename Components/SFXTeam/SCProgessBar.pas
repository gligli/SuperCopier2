...
begin
  ...
  bmp.Canvas.Draw((bmp.Width div 2)-BmpText.Width div 2,(bmp.Height div 2)-BmpText.Height div 2 +1,BmpText);
  BmpText.Free;
...
procedure TSCProgessBar.SetHeight(const Value: Integer);
begin
